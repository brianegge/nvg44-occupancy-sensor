 ...
 *
 *    Author: Brian Egge, Chad Lee, Based on work from Stuart Buchanan, Based on original work by midyear66 with thanks
 *
 */
definition(
    name: "NGV44 Wifi Presence",
    namespace: "brianegge",
    author: "Brian Egge",
